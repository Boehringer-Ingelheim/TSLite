...
#'
#' @description
#' determine enrollment time for patients with piecewise constant rates in
#' time windows.
#'
#'
...
#'
#' @returns a vector of enrollment time
#' @export
#'
#' @examples
...
StaggeredRecruiter <- function(n, accrual_rate){
  ...
  TrialSimulator::StaggeredRecruiter(n = n, accrual_rate = accrual_rate)
