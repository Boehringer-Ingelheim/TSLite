...
#' @param sample_ratio integer vector. Sample ratio of the newly added arm(s)
#' for permuted block randomization. It will be appended to existing sample
#' ratio in the trial.
#' @param ... one or more arm objects returned from \code{arm()}. One exception
...
#' trial
#'
addArms <- function(trial, sample_ratio, ...){
